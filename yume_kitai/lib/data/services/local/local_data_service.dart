  ...
  Future<Database> getDatabaseInstance() async {
    ...
    _db = await openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        await db.execute(
            'CREATE TABLE habits (habit_id INTEGER PRIMARY KEY, habit_name TEXT NOT NULL UNIQUE, habit_freq TEXT NOT NULL, habit_desc TEXT, habit_color TEXT, habit_icon TEXT)');
        await db.execute(
            'CREATE TABLE habit_history (h_history_id INTEGER PRIMARY KEY, h_history_timestamp TEXT NOT NULL, h_history_habit_state TEXT NOT NULL, habit_id INTEGER NOT NULL, FOREIGN KEY (habit_id) REFERENCES habits(habit_id) ON UPDATE CASCADE ON DELETE CASCADE)');
      },
